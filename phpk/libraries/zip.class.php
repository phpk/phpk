...
class Zip extends Base
{
	...
	/**
	 * Adds a file to the zip with the name $name
	 *
	 * @param string $data
	 * @param string $name
	 * @return void
	...
	public function zippedFile()
	{
		...
		return $data . $ctrldir . $this->eofCtrlDir . pack( "v" , sizeof( $this->ctrlDir ) ) . // total number of entries "on this disk"
