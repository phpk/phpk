 ...
 *
 * examples of usage :
 * $myPacker = new Jspacker();
 * $packed = $myPacker->minify($script, 62, true, false);
 * 
 * or
 * 
 * $myPacker = new Jspacker();
 * $packed = $myPacker->minify($script, 'Normal', true, false);
 * 
 * or (default values)
 * 
 * $myPacker = new Jspacker();
 * $packed = $myPacker->minify($script);
 * 
 * 
...
class Jspacker {
	...
	public function minify($_script, $_encoding = 62, $_fastDecode = true, $_specialChars = false) {
